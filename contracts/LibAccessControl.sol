...
library LibAccessControl {
    ...
    bytes32 internal constant ACCESS_CONTROL_STORAGE_POSITION = keccak256("mc01.access.control");
    ...
    function setRoleAdmin(
        ...
        if (_role != ADMIN_ROLE)
            accessStorage().roles[_role].adminRole = _adminRole;
    ...
    function grantRole(
        bytes32 _role,
        address _account
    ) internal onlyRole(getRoleAdmin(_role)) {
        // grant
